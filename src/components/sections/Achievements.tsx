...
export default function Achievements() {
  return (
    <section id="achievements" className="py-32 px-6 md:px-12 lg:px-24 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12">
          {achievements.map((achievement, index) => (
            <motion.div
              key={index}
              className="text-center p-8 rounded-3xl bg-white border border-slate-200 hover:border-brand-blue/30 hover:shadow-lg transition-all"
